  ...
  module LeagueDashPlayerPtShot
    ...
    def self.identity_info(data)
      {player_id: data.fetch("PLAYER_ID", nil), player_name: data.fetch("PLAYER_NAME", nil),
       player_last_team_id: data.fetch("PLAYER_LAST_TEAM_ID", nil),
       player_last_team_abbreviation: data.fetch("PLAYER_LAST_TEAM_ABBREVIATION", nil),
       age: data.fetch("AGE", nil), gp: data.fetch("GP", nil), g: data.fetch("G", nil)}
    end
