...
module NBA
  ...
  #
  # @api public
  class TeamOnOffPlayerStat < Shale::Mapper
    ...
    #   @return [String, nil] the court status
    ...
    # @return [Player, nil] the versus player object
    def vs_player
    ...
    # @example
    #   stat.on_court? #=> true
    # @return [Boolean] true if the player was on the court
    def on_court?
      court_status.eql?("On")
    end
    ...
    # @example
    #   stat.off_court? #=> true
    # @return [Boolean] true if the player was off the court
    def off_court?
