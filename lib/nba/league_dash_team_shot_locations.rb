...
require_relative "league_dash_team_shot_location_stat"
require_relative "utils"

module NBA
  # Provides methods to retrieve league-wide team shot location statistics
  #
  # @api public
  module LeagueDashTeamShotLocations
    ...
    # By zone distance range
    # @return [String] the distance range
    BY_ZONE = "By Zone".freeze

    # Retrieves all league-wide team shot location statistics
    #
    # @api public
    # @example
    #   stats = NBA::LeagueDashTeamShotLocations.all(season: 2024)
    #   stats.first.restricted_area_fg_pct #=> 0.613
    # @param season [Integer] the season year
    # @param season_type [String] the season type
    # @param per_mode [String] the per mode
    # @param distance_range [String] the distance range
    # @param client [Client] the API client to use
    # @return [Collection] a collection of team shot location statistics
    ...
    def self.build_path(season, opts)
      ...
      "leaguedashteamshotlocations?LeagueID=00&Season=#{season_str}" \
    ...
    #
    # @api private
    # @return [Collection] collection of team shot location stats
    ...
    #
    # @api private
    # @return [LeagueDashTeamShotLocationStat] the stat object
    def self.build_stat(data)
      LeagueDashTeamShotLocationStat.new(**identity_info(data), **restricted_area_info(data),
