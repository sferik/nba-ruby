...
module NBA
  class PlayerCompareAdvancedAttributeMappingTest < Minitest::Test
    cover PlayerCompare
    ...
    def test_maps_all_advanced_attributes
      ...
      assert_in_delta 28.5, stat.eff
      assert_in_delta 1.59, stat.ast_tov
      assert_in_delta 0.28, stat.stl_tov
    end
