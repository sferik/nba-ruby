...
module NBA
  class LeagueDashTeamShotLocationsMissingRestrictedAreaKeysTest < Minitest::Test
    cover LeagueDashTeamShotLocations

    def test_handles_missing_restricted_area_fgm
      assert_missing_key_returns_nil("Restricted Area FGM", 2, :restricted_area_fgm)
    end

    def test_handles_missing_restricted_area_fga
      assert_missing_key_returns_nil("Restricted Area FGA", 3, :restricted_area_fga)
    end

    def test_handles_missing_restricted_area_fg_pct
      assert_missing_key_returns_nil("Restricted Area FG_PCT", 4, :restricted_area_fg_pct)
    end
