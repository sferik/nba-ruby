...
module NBA
  class TeamYearByYearStatsShootingAttributeMappingTest < Minitest::Test
    ...
    def test_maps_field_goal_attributes
      ...
      assert_in_delta 43.2, stat.fgm
      assert_in_delta 91.5, stat.fga
      assert_in_delta 0.472, stat.fg_pct
    end

    def test_maps_three_pointer_attributes
      stub_year_stats_request

      stat = TeamYearByYearStats.find(team: Team::GSW).first

      assert_in_delta 14.8, stat.fg3m
      assert_in_delta 40.2, stat.fg3a
      assert_in_delta 0.368, stat.fg3_pct
    end
    ...
    def test_maps_free_throw_attributes
      ...
      assert_in_delta 0.792, stat.ft_pct
    end
