...
module NBA
  class LeagueDashPlayerShotLocationsMissingRestrictedAreaKeysTest < Minitest::Test
    cover LeagueDashPlayerShotLocations

    def test_handles_missing_restricted_area_fgm
      assert_missing_key_returns_nil("Restricted Area FGM", 5, :restricted_area_fgm)
    end

    def test_handles_missing_restricted_area_fga
      assert_missing_key_returns_nil("Restricted Area FGA", 6, :restricted_area_fga)
    end

    def test_handles_missing_restricted_area_fg_pct
      assert_missing_key_returns_nil("Restricted Area FG_PCT", 7, :restricted_area_fg_pct)
    end
