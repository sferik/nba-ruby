...
module NBA
  class LeagueDashTeamShotLocationsCorner3MappingTest < Minitest::Test
    cover LeagueDashTeamShotLocations

    def test_maps_left_corner_3_fgm
      stub_shot_locations_request

      assert_in_delta 1.2, stat.left_corner_3_fgm
    end

    def test_maps_left_corner_3_fga
      stub_shot_locations_request

      assert_in_delta 3.1, stat.left_corner_3_fga
    end

    def test_maps_left_corner_3_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.387, stat.left_corner_3_fg_pct
    end

    def test_maps_right_corner_3_fgm
      stub_shot_locations_request

      assert_in_delta 1.1, stat.right_corner_3_fgm
    end

    def test_maps_right_corner_3_fga
      stub_shot_locations_request

      assert_in_delta 2.8, stat.right_corner_3_fga
    end

    def test_maps_right_corner_3_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.393, stat.right_corner_3_fg_pct
    end

    def test_maps_corner_3_fgm
      stub_shot_locations_request

      assert_in_delta 2.3, stat.corner_3_fgm
    end

    def test_maps_corner_3_fga
      stub_shot_locations_request

      assert_in_delta 5.9, stat.corner_3_fga
    end

    def test_maps_corner_3_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.390, stat.corner_3_fg_pct
    end
