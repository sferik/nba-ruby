...
module NBA
  class LeagueDashPtStatsStatTest < Minitest::Test
    cover LeagueDashPtStatsStat

    def test_objects_with_same_player_id_and_team_id_are_equal
      stat0 = LeagueDashPtStatsStat.new(player_id: 201_939, team_id: Team::GSW)
      stat1 = LeagueDashPtStatsStat.new(player_id: 201_939, team_id: Team::GSW)
    ...
    def test_objects_with_different_player_id_are_not_equal
      stat0 = LeagueDashPtStatsStat.new(player_id: 201_939, team_id: Team::GSW)
      stat1 = LeagueDashPtStatsStat.new(player_id: 2544, team_id: Team::GSW)
    ...
    def test_objects_with_different_team_id_are_not_equal
      stat0 = LeagueDashPtStatsStat.new(player_id: 201_939, team_id: Team::GSW)
      stat1 = LeagueDashPtStatsStat.new(player_id: 201_939, team_id: 1_610_612_747)

      refute_equal stat0, stat1
    end

    def test_player_returns_nil_when_player_id_is_nil
      stat = LeagueDashPtStatsStat.new(player_id: nil)

      assert_nil stat.player
    end

    def test_team_returns_nil_when_team_id_is_nil
      stat = LeagueDashPtStatsStat.new(team_id: nil)
    ...
    def test_player_returns_player_object_when_player_id_valid
      ...
      stat = LeagueDashPtStatsStat.new(player_id: 201_939)
      result = stat.player
    ...
    def test_team_returns_team_object_when_team_id_valid
      stat = LeagueDashPtStatsStat.new(team_id: Team::GSW)
