...
module NBA
  class CollegePlayerStatTest < Minitest::Test
    cover CollegePlayerStat

    def test_equality_based_on_player_id
      stat1 = CollegePlayerStat.new(player_id: 201_939, player_name: "Stephen Curry")
      stat2 = CollegePlayerStat.new(player_id: 201_939, player_name: "Steph")

      assert_equal stat1, stat2
    end

    def test_inequality_when_player_ids_differ
      stat1 = CollegePlayerStat.new(player_id: 201_939)
      stat2 = CollegePlayerStat.new(player_id: 2544)
    ...
    def test_player_fetches_player_by_id
      ...
      stat = CollegePlayerStat.new(player_id: 201_939)
      player = stat.player
