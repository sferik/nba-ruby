...
module NBA
  class DraftCombineDrillResultModelTest < Minitest::Test
    cover DraftCombineDrillResult

    def test_objects_with_same_player_id_are_equal
      result0 = DraftCombineDrillResult.new(player_id: 1_630_162)
      result1 = DraftCombineDrillResult.new(player_id: 1_630_162)
    ...
    def test_objects_with_different_player_id_are_not_equal
      result0 = DraftCombineDrillResult.new(player_id: 1_630_162)
      result1 = DraftCombineDrillResult.new(player_id: 1_630_163)

      refute_equal result0, result1
    end

    def test_player_returns_nil_when_player_id_is_nil
      result = DraftCombineDrillResult.new(player_id: nil)
    ...
    def test_player_returns_player_object_when_player_id_valid
      ...
      result = DraftCombineDrillResult.new(player_id: 1_630_162)
