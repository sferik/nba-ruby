...
module NBA
  class LeagueDashPlayerBioStatsEdgeCasesTest < Minitest::Test
    ...
    def test_returns_empty_collection_for_nil_response
      ...
      result = LeagueDashPlayerBioStats.all(season: 2024, client: mock_client)
    ...
    def test_returns_empty_collection_when_result_sets_missing
      stub_request(:get, /leaguedashplayerbiostats/).to_return(body: {}.to_json)

      assert_empty LeagueDashPlayerBioStats.all(season: 2024)
    end
    ...
    def test_ignores_result_set_with_wrong_name
      ...
      correct_set = {name: "LeagueDashPlayerBioStats", headers: %w[PLAYER_ID], rowSet: [[201_939]]}
    ...
    def test_returns_empty_collection_when_headers_missing
      response = {resultSets: [{name: "LeagueDashPlayerBioStats", rowSet: [[201_939]]}]}
      stub_request(:get, /leaguedashplayerbiostats/).to_return(body: response.to_json)
    ...
    def test_returns_empty_collection_when_row_set_missing
      response = {resultSets: [{name: "LeagueDashPlayerBioStats", headers: %w[PLAYER_ID]}]}
      stub_request(:get, /leaguedashplayerbiostats/).to_return(body: response.to_json)
