...
module NBA
  class LeagueLineupVizStatTest < Minitest::Test
    cover LeagueLineupVizStat

    def test_equality_based_on_group_id_and_team_id
      stat1 = LeagueLineupVizStat.new(group_id: "201939-203110", team_id: Team::GSW)
      stat2 = LeagueLineupVizStat.new(group_id: "201939-203110", team_id: Team::GSW)
    ...
    def test_inequality_with_different_group_id
      stat1 = LeagueLineupVizStat.new(group_id: "201939-203110", team_id: Team::GSW)
      stat2 = LeagueLineupVizStat.new(group_id: "201939-1628369", team_id: Team::GSW)
    ...
    def test_inequality_with_different_team_id
      stat1 = LeagueLineupVizStat.new(group_id: "201939-203110", team_id: Team::GSW)
      stat2 = LeagueLineupVizStat.new(group_id: "201939-203110", team_id: Team::LAL)

      refute_equal stat1, stat2
    end

    def test_team_returns_team_object
      stat = LeagueLineupVizStat.new(team_id: Team::GSW)
