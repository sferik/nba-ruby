...
module NBA
  class LeagueDashPlayerClutchDefaultParameterTest < Minitest::Test
    cover LeagueDashPlayerClutch

    def test_default_season_uses_current_season
      stub_clutch_request

      LeagueDashPlayerClutch.all
    ...
    def test_default_clutch_time_is_last_5_minutes
      stub_clutch_request
    ...
    def stub_clutch_request
      stub_request(:get, /leaguedashplayerclutch/).to_return(body: {resultSets: []}.to_json)
    end
  end
end
