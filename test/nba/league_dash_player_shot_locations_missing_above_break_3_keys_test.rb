...
module NBA
  class LeagueDashPlayerShotLocationsMissingAboveBreak3KeysTest < Minitest::Test
    cover LeagueDashPlayerShotLocations

    def test_handles_missing_above_the_break_3_fgm
      assert_missing_key_returns_nil("Above the Break 3 FGM", 20, :above_the_break_3_fgm)
    end

    def test_handles_missing_above_the_break_3_fga
      assert_missing_key_returns_nil("Above the Break 3 FGA", 21, :above_the_break_3_fga)
    end

    def test_handles_missing_above_the_break_3_fg_pct
      assert_missing_key_returns_nil("Above the Break 3 FG_PCT", 22, :above_the_break_3_fg_pct)
    end
