...
module NBA
  class LeagueDashPlayerShotLocationsRestrictedAreaMappingTest < Minitest::Test
    cover LeagueDashPlayerShotLocations

    def test_maps_restricted_area_fgm
      stub_shot_locations_request

      assert_in_delta 2.5, stat.restricted_area_fgm
    end

    def test_maps_restricted_area_fga
      stub_shot_locations_request

      assert_in_delta 4.2, stat.restricted_area_fga
    end

    def test_maps_restricted_area_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.595, stat.restricted_area_fg_pct
    end
