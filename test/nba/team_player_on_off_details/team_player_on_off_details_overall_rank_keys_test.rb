...
module NBA
  class TeamPlayerOnOffDetailsOverallRankKeysTest < Minitest::Test
    cover TeamPlayerOnOffDetails

    def test_handles_missing_gp_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("GP_RANK").to_json)
    ...
    def test_handles_missing_w_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("W_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_l_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("L_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_w_pct_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("W_PCT_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_min_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("MIN_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_fgm_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("FGM_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_fga_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("FGA_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_fg_pct_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("FG_PCT_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_fg3m_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("FG3M_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_fg3a_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("FG3A_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
