...
module NBA
  class TeamPlayerOnOffSummaryOverallKeysTest < Minitest::Test
    ...
    def test_handles_missing_group_value_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("GROUP_VALUE").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_w_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("W").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_l_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("L").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_w_pct_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("W_PCT").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_fgm_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("FGM").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_fga_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("FGA").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_fg_pct_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("FG_PCT").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
