...
module NBA
  class TeamPlayerOnOffSummaryOverallKeys2Test < Minitest::Test
    cover TeamPlayerOnOffSummary

    def test_handles_missing_fg3m_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("FG3M").to_json)
    ...
    def test_handles_missing_fg3a_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("FG3A").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_fg3_pct_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("FG3_PCT").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_ftm_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("FTM").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_fta_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("FTA").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_ft_pct_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("FT_PCT").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_oreb_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("OREB").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_dreb_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("DREB").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_reb_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("REB").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_ast_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("AST").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_tov_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("TOV").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_stl_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("STL").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_blk_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("BLK").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
