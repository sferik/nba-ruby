...
module NBA
  class DraftHistoryPickPositionAttributeMappingTest < Minitest::Test
    cover DraftHistory

    def test_maps_pick_position_attributes
      stub_draft_request

      pick = DraftHistory.all.first

      assert_equal 1, pick.round_number
      assert_equal 1, pick.round_pick
