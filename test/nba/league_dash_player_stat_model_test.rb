...
module NBA
  class LeagueDashPlayerStatModelTest < Minitest::Test
    cover LeagueDashPlayerStat

    def test_objects_with_same_player_id_and_season_id_are_equal
      stat0 = LeagueDashPlayerStat.new(player_id: 201_939, season_id: "2024-25")
      stat1 = LeagueDashPlayerStat.new(player_id: 201_939, season_id: "2024-25")
    ...
    def test_objects_with_different_player_id_are_not_equal
      stat0 = LeagueDashPlayerStat.new(player_id: 201_939, season_id: "2024-25")
      stat1 = LeagueDashPlayerStat.new(player_id: 2544, season_id: "2024-25")
    ...
    def test_objects_with_different_season_id_are_not_equal
      stat0 = LeagueDashPlayerStat.new(player_id: 201_939, season_id: "2024-25")
      stat1 = LeagueDashPlayerStat.new(player_id: 201_939, season_id: "2023-24")

      refute_equal stat0, stat1
    end

    def test_player_returns_nil_when_player_id_is_nil
      stat = LeagueDashPlayerStat.new(player_id: nil)

      assert_nil stat.player
    end

    def test_team_returns_nil_when_team_id_is_nil
      stat = LeagueDashPlayerStat.new(team_id: nil)
    ...
    def test_player_returns_player_object_when_player_id_valid
      ...
      stat = LeagueDashPlayerStat.new(player_id: 201_939)
      result = stat.player
    ...
    def test_team_returns_team_object_when_team_id_valid
      stat = LeagueDashPlayerStat.new(team_id: Team::GSW)
