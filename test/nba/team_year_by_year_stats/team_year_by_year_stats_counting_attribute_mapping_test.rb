...
module NBA
  class TeamYearByYearStatsCountingAttributeMappingTest < Minitest::Test
    cover TeamYearByYearStats

    def test_maps_rebound_and_assist_attributes
      stub_year_stats_request

      stat = TeamYearByYearStats.find(team: Team::GSW).first

      assert_in_delta 10.5, stat.oreb
      assert_in_delta 33.8, stat.dreb
      assert_in_delta 44.3, stat.reb
      assert_in_delta 28.1, stat.ast
    end
    ...
    def test_maps_scoring_attributes
      ...
      assert_in_delta 118.7, stat.pts
