...
module NBA
  class BoxScoreAdvancedPlayerStatTest < Minitest::Test
    cover BoxScoreAdvancedPlayerStat

    def test_objects_with_same_game_id_and_player_id_are_equal
      stat0 = BoxScoreAdvancedPlayerStat.new(game_id: "001", player_id: 123)
      stat1 = BoxScoreAdvancedPlayerStat.new(game_id: "001", player_id: 123)
    ...
    def test_objects_with_different_player_id_are_not_equal
      stat0 = BoxScoreAdvancedPlayerStat.new(game_id: "001", player_id: 123)
      stat1 = BoxScoreAdvancedPlayerStat.new(game_id: "001", player_id: 456)
    ...
    def test_player_returns_player_object
      ...
      stat = BoxScoreAdvancedPlayerStat.new(player_id: 201_939)
    ...
    def test_player_returns_nil_when_player_id_is_nil
      stat = BoxScoreAdvancedPlayerStat.new(player_id: nil)

      assert_nil stat.player
    end

    def test_team_returns_team_object
      stat = BoxScoreAdvancedPlayerStat.new(team_id: Team::GSW)
