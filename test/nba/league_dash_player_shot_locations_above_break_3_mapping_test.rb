...
module NBA
  class LeagueDashPlayerShotLocationsAboveBreak3MappingTest < Minitest::Test
    cover LeagueDashPlayerShotLocations

    def test_maps_above_the_break_3_fgm
      stub_shot_locations_request

      assert_in_delta 2.8, stat.above_the_break_3_fgm
    end

    def test_maps_above_the_break_3_fga
      stub_shot_locations_request

      assert_in_delta 7.2, stat.above_the_break_3_fga
    end

    def test_maps_above_the_break_3_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.389, stat.above_the_break_3_fg_pct
    end
