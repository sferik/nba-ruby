...
module NBA
  class BoxScoreHustlePlayerStatsTest < Minitest::Test
    cover BoxScoreHustle

    def test_player_stats_returns_collection
      stub_hustle_request

      result = BoxScoreHustle.player_stats(game: "0022400001")
    ...
    def test_player_stats_uses_correct_game_id_in_path
      ...
      BoxScoreHustle.player_stats(game: "0022400001")
    ...
    def test_player_stats_accepts_game_object
      ...
      BoxScoreHustle.player_stats(game: game)
    ...
    def test_player_stats_accepts_custom_client
      ...
      BoxScoreHustle.player_stats(game: "0022400001", client: mock_client)
