...
module NBA
  class BoxScoreScoringPlayerStatTest < Minitest::Test
    cover BoxScoreScoringPlayerStat

    def test_objects_with_same_game_id_and_player_id_are_equal
      stat0 = BoxScoreScoringPlayerStat.new(game_id: "001", player_id: 123)
      stat1 = BoxScoreScoringPlayerStat.new(game_id: "001", player_id: 123)
    ...
    def test_player_returns_player_object_when_player_id_valid
      ...
      stat = BoxScoreScoringPlayerStat.new(player_id: 201_939)
      result = stat.player
    ...
    def test_team_returns_nil_when_team_id_is_nil
      stat = BoxScoreScoringPlayerStat.new(team_id: nil)

      assert_nil stat.team
    end

    def test_team_returns_team_object_when_team_id_valid
      stat = BoxScoreScoringPlayerStat.new(team_id: Team::GSW)
    ...
    def test_game_returns_nil_when_game_id_is_nil
      stat = BoxScoreScoringPlayerStat.new(game_id: nil)
    ...
    def test_game_returns_game_object_when_game_id_valid
      ...
      stat = BoxScoreScoringPlayerStat.new(game_id: "0022400001")
      result = stat.game
    ...
    def player_info_response
      headers = %w[PERSON_ID DISPLAY_FIRST_LAST FIRST_NAME LAST_NAME ROSTERSTATUS JERSEY HEIGHT WEIGHT
