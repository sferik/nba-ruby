...
module NBA
  class LeagueDashPtTeamDefendEdgeCasesTest < Minitest::Test
    ...
    def test_returns_empty_collection_for_nil_response
      ...
      result = LeagueDashPtTeamDefend.all(season: 2024, client: mock_client)
    ...
    def test_returns_empty_collection_when_result_sets_missing
      stub_request(:get, /leaguedashptteamdefend/).to_return(body: {}.to_json)

      assert_empty LeagueDashPtTeamDefend.all(season: 2024)
    end
    ...
    def test_ignores_result_set_with_wrong_name
      ...
      correct_set = {name: "LeagueDashPtTeamDefend", headers: %w[TEAM_ID], rowSet: [[Team::GSW]]}
    ...
    def test_returns_empty_collection_when_headers_missing
      response = {resultSets: [{name: "LeagueDashPtTeamDefend", rowSet: [[Team::GSW]]}]}
      stub_request(:get, /leaguedashptteamdefend/).to_return(body: response.to_json)
    ...
    def test_returns_empty_collection_when_row_set_missing
      response = {resultSets: [{name: "LeagueDashPtTeamDefend", headers: %w[TEAM_ID]}]}
      stub_request(:get, /leaguedashptteamdefend/).to_return(body: response.to_json)
