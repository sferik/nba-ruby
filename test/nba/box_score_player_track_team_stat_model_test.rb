...
module NBA
  class BoxScorePlayerTrackTeamStatModelTest < Minitest::Test
    cover BoxScorePlayerTrackTeamStat

    def test_objects_with_same_game_id_and_team_id_are_equal
      stat0 = BoxScorePlayerTrackTeamStat.new(game_id: "0022400001", team_id: Team::GSW)
      stat1 = BoxScorePlayerTrackTeamStat.new(game_id: "0022400001", team_id: Team::GSW)
    ...
    def test_objects_with_different_game_id_are_not_equal
      stat0 = BoxScorePlayerTrackTeamStat.new(game_id: "0022400001", team_id: Team::GSW)
      stat1 = BoxScorePlayerTrackTeamStat.new(game_id: "0022400002", team_id: Team::GSW)
    ...
    def test_objects_with_different_team_id_are_not_equal
      stat0 = BoxScorePlayerTrackTeamStat.new(game_id: "0022400001", team_id: Team::GSW)
      stat1 = BoxScorePlayerTrackTeamStat.new(game_id: "0022400001", team_id: 1_610_612_747)

      refute_equal stat0, stat1
    end

    def test_team_returns_nil_when_team_id_is_nil
      stat = BoxScorePlayerTrackTeamStat.new(team_id: nil)

      assert_nil stat.team
    end

    def test_game_returns_nil_when_game_id_is_nil
      stat = BoxScorePlayerTrackTeamStat.new(game_id: nil)

      assert_nil stat.game
    end

    def test_team_returns_team_object_when_team_id_valid
      stat = BoxScorePlayerTrackTeamStat.new(team_id: Team::GSW)
    ...
    def test_game_returns_game_object_when_game_id_valid
      ...
      stat = BoxScorePlayerTrackTeamStat.new(game_id: "0022400001")
      result = stat.game
