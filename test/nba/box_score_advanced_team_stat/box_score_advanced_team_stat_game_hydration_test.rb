...
module NBA
  class BoxScoreAdvancedTeamStatGameHydrationTest < Minitest::Test
    cover BoxScoreAdvancedTeamStat

    def test_game_returns_hydrated_game_object
      stub_box_score_summary_request("0022400001")
      stat = BoxScoreAdvancedTeamStat.new(game_id: "0022400001")
    ...
    def test_game_returns_nil_when_game_id_is_nil
      stat = BoxScoreAdvancedTeamStat.new(game_id: nil)
