...
module NBA
  class PlayerCompareCountingAttributeMappingTest < Minitest::Test
    cover PlayerCompare
    ...
    def test_maps_playmaking_and_defense_attributes
      stub_compare_request
    ...
    def test_maps_scoring_and_turnover_attributes
      stub_compare_request
