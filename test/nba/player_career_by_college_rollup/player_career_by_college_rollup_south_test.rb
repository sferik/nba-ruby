...
module NBA
  class PlayerCareerByCollegeRollupSouthTest < Minitest::Test
    cover PlayerCareerByCollegeRollup

    def test_south_parses_gp
      stub_rollup_request
    ...
    def test_south_parses_shooting_stats
      stub_rollup_request
    ...
    def test_south_parses_three_point_stats
      stub_rollup_request
    ...
    def test_south_parses_free_throw_stats
      stub_rollup_request
    ...
    def test_south_parses_counting_stats
      stub_rollup_request
    ...
    def test_south_parses_other_counting_stats
      stub_rollup_request
