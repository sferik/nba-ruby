...
module NBA
  class HustleStatsBoxScoreTeamAttributeMappingTest < Minitest::Test
    cover HustleStatsBoxScore

    def test_maps_team_identity_attributes
      stub_hustle_request
      stat = HustleStatsBoxScore.team_stats(game: "0022400001").first
    ...
    def team_headers
      %w[TEAM_ID TEAM_NAME TEAM_ABBREVIATION TEAM_CITY MINUTES PTS
