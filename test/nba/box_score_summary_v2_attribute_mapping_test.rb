...
module NBA
  class BoxScoreSummaryV2AttributeMappingTest < Minitest::Test
    cover BoxScoreSummaryV2

    def test_maps_game_status_attributes
    ...
    def test_maps_team_id_attributes
      stub_summary_request
      summary = BoxScoreSummaryV2.find(game: "0022400001")
    ...
    def test_maps_live_game_attributes
      stub_summary_request
      summary = BoxScoreSummaryV2.find(game: "0022400001")
    ...
    def test_maps_home_quarter_scores
      ...
      assert_equal [28, 32, 25, 33, 0, 118],
        [summary.home_pts_q1, summary.home_pts_q2, summary.home_pts_q3, summary.home_pts_q4,
          summary.home_pts_ot, summary.home_pts]
    end
    ...
    def test_maps_visitor_quarter_scores
      ...
      assert_equal [25, 28, 30, 26, 0, 109],
        [summary.visitor_pts_q1, summary.visitor_pts_q2, summary.visitor_pts_q3, summary.visitor_pts_q4,
          summary.visitor_pts_ot, summary.visitor_pts]
    end
