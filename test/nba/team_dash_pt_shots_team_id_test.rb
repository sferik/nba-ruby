...
module NBA
  class TeamDashPtShotsTeamIdTest < Minitest::Test
    cover TeamDashPtShots

    def test_shot_clock_includes_team_id_in_path
      stub_request(:get, /TeamID=1610612744/).to_return(body: shot_clock_response.to_json)
    ...
    def test_dribble_includes_team_id_in_path
      stub_request(:get, /TeamID=1610612744/).to_return(body: dribble_response.to_json)
    ...
    def test_closest_defender_includes_team_id_in_path
      stub_request(:get, /TeamID=1610612744/).to_return(body: closest_defender_response.to_json)
    ...
    def test_closest_defender_10ft_includes_team_id_in_path
      stub_request(:get, /TeamID=1610612744/).to_return(body: closest_defender_10ft_response.to_json)
    ...
    def test_touch_time_includes_team_id_in_path
      stub_request(:get, /TeamID=1610612744/).to_return(body: touch_time_response.to_json)
