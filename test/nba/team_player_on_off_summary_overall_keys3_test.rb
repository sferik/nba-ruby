...
module NBA
  class TeamPlayerOnOffSummaryOverallKeys3Test < Minitest::Test
    cover TeamPlayerOnOffSummary

    def test_handles_missing_blka_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("BLKA").to_json)
    ...
    def test_handles_missing_pf_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("PF").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_pfd_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("PFD").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_pts_key
      stub_request(:get, /teamplayeronoffsummary/).to_return(body: response_missing_key("PTS").to_json)
      result = TeamPlayerOnOffSummary.overall(team: 1_610_612_744).first
