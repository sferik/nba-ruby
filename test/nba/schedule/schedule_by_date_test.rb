...
module NBA
  class ScheduleByDateTest < Minitest::Test
    cover Schedule

    def test_by_date_returns_collection
      stub_schedule_request

      assert_instance_of Collection, Schedule.by_date(date: Date.new(2024, 10, 22))
    end

    def test_by_date_filters_by_date
      stub_schedule_request
    ...
    def test_by_date_returns_empty_for_non_matching_date
      stub_schedule_request
