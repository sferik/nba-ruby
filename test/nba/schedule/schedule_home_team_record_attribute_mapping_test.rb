...
module NBA
  class ScheduleHomeTeamRecordAttributeMappingTest < Minitest::Test
    cover Schedule

    def test_maps_home_team_record_attributes
      stub_schedule_request

      game = Schedule.all.first

      assert_equal 46, game.home_team_wins
      assert_equal 36, game.home_team_losses
