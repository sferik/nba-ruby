...
module NBA
  class LeagueDashPlayerShotLocationsMissingBackcourtKeysTest < Minitest::Test
    cover LeagueDashPlayerShotLocations

    def test_handles_missing_backcourt_fgm
      assert_missing_key_returns_nil("Backcourt FGM", 23, :backcourt_fgm)
    end

    def test_handles_missing_backcourt_fga
      assert_missing_key_returns_nil("Backcourt FGA", 24, :backcourt_fga)
    end

    def test_handles_missing_backcourt_fg_pct
      assert_missing_key_returns_nil("Backcourt FG_PCT", 25, :backcourt_fg_pct)
    end
