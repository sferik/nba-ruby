...
module NBA
  class LeagueDashPlayerPtShotEdgeCasesTest < Minitest::Test
    ...
    def test_returns_empty_collection_for_nil_response
      ...
      result = LeagueDashPlayerPtShot.all(season: 2024, client: mock_client)
    ...
    def test_returns_empty_collection_when_result_sets_missing
      stub_request(:get, /leaguedashplayerptshot/).to_return(body: {}.to_json)

      assert_empty LeagueDashPlayerPtShot.all(season: 2024)
    end
    ...
    def test_ignores_result_set_with_wrong_name
      ...
      correct_set = {name: "LeagueDashPTShots", headers: %w[PLAYER_ID], rowSet: [[201_939]]}
    ...
    def test_returns_empty_collection_when_headers_missing
      response = {resultSets: [{name: "LeagueDashPTShots", rowSet: [[201_939]]}]}
      stub_request(:get, /leaguedashplayerptshot/).to_return(body: response.to_json)
    ...
    def test_returns_empty_collection_when_row_set_missing
      response = {resultSets: [{name: "LeagueDashPTShots", headers: %w[PLAYER_ID]}]}
      stub_request(:get, /leaguedashplayerptshot/).to_return(body: response.to_json)
