...
module NBA
  class BoxScorePlayerTrackStatModelTest < Minitest::Test
    cover BoxScorePlayerTrackStat

    def test_objects_with_same_game_id_and_player_id_are_equal
      stat0 = BoxScorePlayerTrackStat.new(game_id: "0022400001", player_id: 201_939)
      stat1 = BoxScorePlayerTrackStat.new(game_id: "0022400001", player_id: 201_939)
    ...
    def test_objects_with_different_game_id_are_not_equal
      stat0 = BoxScorePlayerTrackStat.new(game_id: "0022400001", player_id: 201_939)
      stat1 = BoxScorePlayerTrackStat.new(game_id: "0022400002", player_id: 201_939)
    ...
    def test_objects_with_different_player_id_are_not_equal
      stat0 = BoxScorePlayerTrackStat.new(game_id: "0022400001", player_id: 201_939)
      stat1 = BoxScorePlayerTrackStat.new(game_id: "0022400001", player_id: 2544)

      refute_equal stat0, stat1
    end

    def test_player_returns_nil_when_player_id_is_nil
      stat = BoxScorePlayerTrackStat.new(player_id: nil)

      assert_nil stat.player
    end

    def test_team_returns_nil_when_team_id_is_nil
      stat = BoxScorePlayerTrackStat.new(team_id: nil)

      assert_nil stat.team
    end

    def test_game_returns_nil_when_game_id_is_nil
      stat = BoxScorePlayerTrackStat.new(game_id: nil)
    ...
    def test_player_returns_player_object_when_player_id_valid
      ...
      stat = BoxScorePlayerTrackStat.new(player_id: 201_939)
      result = stat.player
    ...
    def test_team_returns_team_object_when_team_id_valid
      stat = BoxScorePlayerTrackStat.new(team_id: Team::GSW)
    ...
    def test_game_returns_game_object_when_game_id_valid
      ...
      stat = BoxScorePlayerTrackStat.new(game_id: "0022400001")
      result = stat.game
