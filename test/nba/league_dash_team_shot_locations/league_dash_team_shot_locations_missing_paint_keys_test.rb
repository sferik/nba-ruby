...
module NBA
  class LeagueDashTeamShotLocationsMissingPaintKeysTest < Minitest::Test
    cover LeagueDashTeamShotLocations

    def test_handles_missing_in_the_paint_non_ra_fgm
      assert_missing_key_returns_nil("In The Paint (Non-RA) FGM", 5, :in_the_paint_non_ra_fgm)
    end

    def test_handles_missing_in_the_paint_non_ra_fga
      assert_missing_key_returns_nil("In The Paint (Non-RA) FGA", 6, :in_the_paint_non_ra_fga)
    end

    def test_handles_missing_in_the_paint_non_ra_fg_pct
      assert_missing_key_returns_nil("In The Paint (Non-RA) FG_PCT", 7, :in_the_paint_non_ra_fg_pct)
    end
