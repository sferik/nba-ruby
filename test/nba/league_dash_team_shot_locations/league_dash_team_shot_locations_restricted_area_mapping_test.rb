...
module NBA
  class LeagueDashTeamShotLocationsRestrictedAreaMappingTest < Minitest::Test
    cover LeagueDashTeamShotLocations

    def test_maps_restricted_area_fgm
      stub_shot_locations_request

      assert_in_delta 15.2, stat.restricted_area_fgm
    end

    def test_maps_restricted_area_fga
      stub_shot_locations_request

      assert_in_delta 24.8, stat.restricted_area_fga
    end

    def test_maps_restricted_area_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.613, stat.restricted_area_fg_pct
    end
