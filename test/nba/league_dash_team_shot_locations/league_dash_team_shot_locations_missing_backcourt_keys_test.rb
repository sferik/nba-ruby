...
module NBA
  class LeagueDashTeamShotLocationsMissingBackcourtKeysTest < Minitest::Test
    cover LeagueDashTeamShotLocations

    def test_handles_missing_backcourt_fgm
      assert_missing_key_returns_nil("Backcourt FGM", 20, :backcourt_fgm)
    end

    def test_handles_missing_backcourt_fga
      assert_missing_key_returns_nil("Backcourt FGA", 21, :backcourt_fga)
    end

    def test_handles_missing_backcourt_fg_pct
      assert_missing_key_returns_nil("Backcourt FG_PCT", 22, :backcourt_fg_pct)
    end
