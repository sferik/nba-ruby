...
module NBA
  class LeagueDashTeamShotLocationsMissingAboveBreak3KeysTest < Minitest::Test
    cover LeagueDashTeamShotLocations

    def test_handles_missing_above_the_break_3_fgm
      assert_missing_key_returns_nil("Above the Break 3 FGM", 17, :above_the_break_3_fgm)
    end

    def test_handles_missing_above_the_break_3_fga
      assert_missing_key_returns_nil("Above the Break 3 FGA", 18, :above_the_break_3_fga)
    end

    def test_handles_missing_above_the_break_3_fg_pct
      assert_missing_key_returns_nil("Above the Break 3 FG_PCT", 19, :above_the_break_3_fg_pct)
    end
