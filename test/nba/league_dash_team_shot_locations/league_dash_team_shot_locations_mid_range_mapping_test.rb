...
module NBA
  class LeagueDashTeamShotLocationsMidRangeMappingTest < Minitest::Test
    cover LeagueDashTeamShotLocations

    def test_maps_mid_range_fgm
      stub_shot_locations_request

      assert_in_delta 4.5, stat.mid_range_fgm
    end

    def test_maps_mid_range_fga
      stub_shot_locations_request

      assert_in_delta 11.3, stat.mid_range_fga
    end

    def test_maps_mid_range_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.398, stat.mid_range_fg_pct
    end
