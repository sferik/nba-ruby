...
module NBA
  class LeagueDashTeamShotLocationsMissingCorner3KeysTest < Minitest::Test
    cover LeagueDashTeamShotLocations

    def test_handles_missing_left_corner_3_fgm
      assert_missing_key_returns_nil("Left Corner 3 FGM", 11, :left_corner_3_fgm)
    end

    def test_handles_missing_left_corner_3_fga
      assert_missing_key_returns_nil("Left Corner 3 FGA", 12, :left_corner_3_fga)
    end

    def test_handles_missing_left_corner_3_fg_pct
      assert_missing_key_returns_nil("Left Corner 3 FG_PCT", 13, :left_corner_3_fg_pct)
    end

    def test_handles_missing_right_corner_3_fgm
      assert_missing_key_returns_nil("Right Corner 3 FGM", 14, :right_corner_3_fgm)
    end

    def test_handles_missing_right_corner_3_fga
      assert_missing_key_returns_nil("Right Corner 3 FGA", 15, :right_corner_3_fga)
    end

    def test_handles_missing_right_corner_3_fg_pct
      assert_missing_key_returns_nil("Right Corner 3 FG_PCT", 16, :right_corner_3_fg_pct)
    end

    def test_handles_missing_corner_3_fgm
      assert_missing_key_returns_nil("Corner 3 FGM", 23, :corner_3_fgm)
    end

    def test_handles_missing_corner_3_fga
      assert_missing_key_returns_nil("Corner 3 FGA", 24, :corner_3_fga)
    end

    def test_handles_missing_corner_3_fg_pct
      assert_missing_key_returns_nil("Corner 3 FG_PCT", 25, :corner_3_fg_pct)
    end
