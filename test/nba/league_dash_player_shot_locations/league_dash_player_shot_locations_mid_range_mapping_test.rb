...
module NBA
  class LeagueDashPlayerShotLocationsMidRangeMappingTest < Minitest::Test
    cover LeagueDashPlayerShotLocations

    def test_maps_mid_range_fgm
      stub_shot_locations_request

      assert_in_delta 0.8, stat.mid_range_fgm
    end

    def test_maps_mid_range_fga
      stub_shot_locations_request

      assert_in_delta 2.1, stat.mid_range_fga
    end

    def test_maps_mid_range_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.381, stat.mid_range_fg_pct
    end
