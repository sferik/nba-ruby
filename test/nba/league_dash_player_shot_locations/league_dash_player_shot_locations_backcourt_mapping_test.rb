...
module NBA
  class LeagueDashPlayerShotLocationsBackcourtMappingTest < Minitest::Test
    cover LeagueDashPlayerShotLocations

    def test_maps_backcourt_fgm
      stub_shot_locations_request

      assert_in_delta 0.0, stat.backcourt_fgm
    end

    def test_maps_backcourt_fga
      stub_shot_locations_request

      assert_in_delta 0.1, stat.backcourt_fga
    end

    def test_maps_backcourt_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.0, stat.backcourt_fg_pct
    end
