...
module NBA
  class LeagueDashPlayerShotLocationsCorner3MappingTest < Minitest::Test
    cover LeagueDashPlayerShotLocations

    def test_maps_left_corner_3_fgm
      stub_shot_locations_request

      assert_in_delta 0.4, stat.left_corner_3_fgm
    end

    def test_maps_left_corner_3_fga
      stub_shot_locations_request

      assert_in_delta 0.9, stat.left_corner_3_fga
    end

    def test_maps_left_corner_3_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.444, stat.left_corner_3_fg_pct
    end

    def test_maps_right_corner_3_fgm
      stub_shot_locations_request

      assert_in_delta 0.3, stat.right_corner_3_fgm
    end

    def test_maps_right_corner_3_fga
      stub_shot_locations_request

      assert_in_delta 0.7, stat.right_corner_3_fga
    end

    def test_maps_right_corner_3_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.429, stat.right_corner_3_fg_pct
    end

    def test_maps_corner_3_fgm
      stub_shot_locations_request

      assert_in_delta 0.7, stat.corner_3_fgm
    end

    def test_maps_corner_3_fga
      stub_shot_locations_request

      assert_in_delta 1.6, stat.corner_3_fga
    end

    def test_maps_corner_3_fg_pct
      stub_shot_locations_request

      assert_in_delta 0.438, stat.corner_3_fg_pct
    end
