...
module NBA
  class GameRotationAwayTeamClientPassThroughTest < Minitest::Test
    cover GameRotation

    def test_away_team_passes_client_through
      mock_client = Minitest::Mock.new
      mock_client.expect :get, rotation_response.to_json, [String]

      GameRotation.away_team(game: "0022400001", client: mock_client)
