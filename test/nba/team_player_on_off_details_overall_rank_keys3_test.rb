...
module NBA
  class TeamPlayerOnOffDetailsOverallRankKeys3Test < Minitest::Test
    cover TeamPlayerOnOffDetails

    def test_handles_missing_blk_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("BLK_RANK").to_json)
    ...
    def test_handles_missing_blka_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("BLKA_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_pf_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("PF_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_pfd_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("PFD_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_pts_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("PTS_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
    ...
    def test_handles_missing_plus_minus_rank_key
      stub_request(:get, /teamplayeronoffdetails/).to_return(body: response_missing_key("PLUS_MINUS_RANK").to_json)
      result = TeamPlayerOnOffDetails.overall(team: 1_610_612_744).first
