...
module NBA
  class DraftCombineNonStationaryShootingEdgeCasesTest < Minitest::Test
    ...
    def test_returns_empty_when_response_nil
      ...
      result = DraftCombineNonStationaryShooting.all(season: 2019, client: mock_client)
    ...
    def test_returns_empty_when_no_result_sets
      stub_request(:get, /draftcombinenonstationaryshooting/).to_return(body: {resultSets: nil}.to_json)

      assert_equal 0, DraftCombineNonStationaryShooting.all(season: 2019).size
    end

    def test_returns_empty_when_result_sets_key_missing
      stub_request(:get, /draftcombinenonstationaryshooting/).to_return(body: {}.to_json)
    ...
    def test_handles_multiple_results
      stub_request(:get, /draftcombinenonstationaryshooting/).to_return(body: multi_result_response.to_json)
