...
module NBA
  class BoxScoreUsagePlayerStatTest < Minitest::Test
    cover BoxScoreUsagePlayerStat

    def test_objects_with_same_game_id_and_player_id_are_equal
      stat0 = BoxScoreUsagePlayerStat.new(game_id: "001", player_id: 123)
      stat1 = BoxScoreUsagePlayerStat.new(game_id: "001", player_id: 123)

      assert_equal stat0, stat1
    end

    def test_starter_returns_true_when_start_position_present
      stat = BoxScoreUsagePlayerStat.new(start_position: "G")

      assert_predicate stat, :starter?
    end

    def test_starter_returns_false_when_start_position_nil
      stat = BoxScoreUsagePlayerStat.new(start_position: nil)

      refute_predicate stat, :starter?
    end

    def test_starter_returns_false_when_start_position_empty
      stat = BoxScoreUsagePlayerStat.new(start_position: "")

      refute_predicate stat, :starter?
    end

    def test_player_returns_nil_when_player_id_is_nil
      stat = BoxScoreUsagePlayerStat.new(player_id: nil)
    ...
    def test_player_returns_player_object_when_player_id_valid
      ...
      stat = BoxScoreUsagePlayerStat.new(player_id: 201_939)
      result = stat.player
    ...
    def test_team_returns_nil_when_team_id_is_nil
      stat = BoxScoreUsagePlayerStat.new(team_id: nil)

      assert_nil stat.team
    end

    def test_team_returns_team_object_when_team_id_valid
      stat = BoxScoreUsagePlayerStat.new(team_id: Team::GSW)
    ...
    def test_game_returns_nil_when_game_id_is_nil
      stat = BoxScoreUsagePlayerStat.new(game_id: nil)
    ...
    def test_game_returns_game_object_when_game_id_valid
      ...
      stat = BoxScoreUsagePlayerStat.new(game_id: "0022400001")
      result = stat.game
