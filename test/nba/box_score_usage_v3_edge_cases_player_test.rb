...
module NBA
  class BoxScoreUsageV3EdgeCasesPlayerTest < Minitest::Test
    ...
    def test_player_stats_with_period_params
      ...
      BoxScoreUsageV3.player_stats(game: "0022400001", start_period: 1, end_period: 2)
    ...
    def test_player_stats_uses_default_period_params
      ...
      BoxScoreUsageV3.player_stats(game: "0022400001")
    ...
    def test_player_stats_accepts_game_object
      ...
      BoxScoreUsageV3.player_stats(game: game)
    ...
    def test_player_stats_returns_empty_when_response_is_nil
      ...
      assert_equal 0, BoxScoreUsageV3.player_stats(game: "0022400001", client: mock_client).size
      mock_client.verify
    end
    ...
    def test_player_stats_returns_empty_when_no_box_score
      ...
      assert_equal 0, BoxScoreUsageV3.player_stats(game: "0022400001").size
    end

    def test_handles_empty_players_array
      response = {boxScoreUsage: {homeTeam: {players: []}, awayTeam: {players: []}}}
    ...
    def test_handles_nil_players_in_team
      response = {boxScoreUsage: {homeTeam: {players: nil}, awayTeam: {players: nil}}}
      stub_request(:get, /boxscoreusagev3/).to_return(body: response.to_json)
    ...
    def test_handles_missing_home_team
      response = {boxScoreUsage: {awayTeam: {players: [usage_player_data]}}}
      stub_request(:get, /boxscoreusagev3/).to_return(body: response.to_json)

      assert_equal 1, BoxScoreUsageV3.player_stats(game: "0022400001").size
    end

    def test_handles_missing_away_team
      response = {boxScoreUsage: {homeTeam: {players: [usage_player_data]}}}
      stub_request(:get, /boxscoreusagev3/).to_return(body: response.to_json)
