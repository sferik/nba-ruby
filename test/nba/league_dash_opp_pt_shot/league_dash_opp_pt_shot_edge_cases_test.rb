...
module NBA
  class LeagueDashOppPtShotEdgeCasesTest < Minitest::Test
    ...
    def test_returns_empty_collection_for_nil_response
      ...
      result = LeagueDashOppPtShot.all(season: 2024, client: mock_client)
    ...
    def test_returns_empty_collection_when_result_sets_missing
      stub_request(:get, /leaguedashoppptshot/).to_return(body: {}.to_json)

      assert_empty LeagueDashOppPtShot.all(season: 2024)
    end
