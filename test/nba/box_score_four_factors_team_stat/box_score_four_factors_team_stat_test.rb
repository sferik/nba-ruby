...
module NBA
  class BoxScoreFourFactorsTeamStatTest < Minitest::Test
    cover BoxScoreFourFactorsTeamStat

    def test_objects_with_same_game_id_and_team_id_are_equal
      stat0 = BoxScoreFourFactorsTeamStat.new(game_id: "001", team_id: Team::GSW)
      stat1 = BoxScoreFourFactorsTeamStat.new(game_id: "001", team_id: Team::GSW)

      assert_equal stat0, stat1
    end

    def test_team_returns_nil_when_team_id_is_nil
      stat = BoxScoreFourFactorsTeamStat.new(team_id: nil)

      assert_nil stat.team
    end

    def test_team_returns_team_object_when_team_id_valid
      stat = BoxScoreFourFactorsTeamStat.new(team_id: Team::GSW)
    ...
    def test_game_returns_nil_when_game_id_is_nil
      stat = BoxScoreFourFactorsTeamStat.new(game_id: nil)
    ...
    def test_game_returns_game_object_when_game_id_valid
      ...
      stat = BoxScoreFourFactorsTeamStat.new(game_id: "0022400001")
      result = stat.game
