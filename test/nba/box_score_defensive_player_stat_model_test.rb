...
module NBA
  class BoxScoreDefensivePlayerStatModelTest < Minitest::Test
    cover BoxScoreDefensivePlayerStat

    def test_objects_with_same_game_id_and_person_id_are_equal
      stat0 = BoxScoreDefensivePlayerStat.new(game_id: "0022400001", person_id: 201_939)
      stat1 = BoxScoreDefensivePlayerStat.new(game_id: "0022400001", person_id: 201_939)
    ...
    def test_objects_with_different_game_id_are_not_equal
      stat0 = BoxScoreDefensivePlayerStat.new(game_id: "0022400001", person_id: 201_939)
      stat1 = BoxScoreDefensivePlayerStat.new(game_id: "0022400002", person_id: 201_939)
    ...
    def test_objects_with_different_person_id_are_not_equal
      stat0 = BoxScoreDefensivePlayerStat.new(game_id: "0022400001", person_id: 201_939)
      stat1 = BoxScoreDefensivePlayerStat.new(game_id: "0022400001", person_id: 2544)

      refute_equal stat0, stat1
    end

    def test_player_returns_nil_when_person_id_is_nil
      stat = BoxScoreDefensivePlayerStat.new(person_id: nil)

      assert_nil stat.player
    end

    def test_team_returns_nil_when_team_id_is_nil
      stat = BoxScoreDefensivePlayerStat.new(team_id: nil)

      assert_nil stat.team
    end

    def test_game_returns_nil_when_game_id_is_nil
      stat = BoxScoreDefensivePlayerStat.new(game_id: nil)
    ...
    def test_player_returns_player_object_when_person_id_valid
      ...
      stat = BoxScoreDefensivePlayerStat.new(person_id: 201_939)
      result = stat.player
    ...
    def test_team_returns_team_object_when_team_id_valid
      stat = BoxScoreDefensivePlayerStat.new(team_id: Team::GSW)
    ...
    def test_game_returns_game_object_when_game_id_valid
      ...
      stat = BoxScoreDefensivePlayerStat.new(game_id: "0022400001")
      result = stat.game
    ...
    def test_starter_returns_true_when_position_present
      stat = BoxScoreDefensivePlayerStat.new(position: "G")

      assert_predicate stat, :starter?
    end

    def test_starter_returns_false_when_position_nil
      stat = BoxScoreDefensivePlayerStat.new(position: nil)

      refute_predicate stat, :starter?
    end

    def test_starter_returns_false_when_position_empty
      stat = BoxScoreDefensivePlayerStat.new(position: "")
