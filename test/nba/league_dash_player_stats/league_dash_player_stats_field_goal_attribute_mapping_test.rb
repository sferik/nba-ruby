...
module NBA
  class LeagueDashPlayerStatsFieldGoalAttributeMappingTest < Minitest::Test
    cover LeagueDashPlayerStats

    def test_maps_field_goals_made
    ...
    def test_maps_field_goals_attempted
      stub_player_stats_request
    ...
    def test_maps_field_goal_percentage
      stub_player_stats_request
    ...
    def test_maps_three_pointers_made
      stub_player_stats_request
    ...
    def test_maps_three_pointers_attempted
      stub_player_stats_request
    ...
    def test_maps_three_point_percentage
      stub_player_stats_request
