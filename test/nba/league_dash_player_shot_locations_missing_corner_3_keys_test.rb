...
module NBA
  class LeagueDashPlayerShotLocationsMissingCorner3KeysTest < Minitest::Test
    cover LeagueDashPlayerShotLocations

    def test_handles_missing_left_corner_3_fgm
      assert_missing_key_returns_nil("Left Corner 3 FGM", 14, :left_corner_3_fgm)
    end

    def test_handles_missing_left_corner_3_fga
      assert_missing_key_returns_nil("Left Corner 3 FGA", 15, :left_corner_3_fga)
    end

    def test_handles_missing_left_corner_3_fg_pct
      assert_missing_key_returns_nil("Left Corner 3 FG_PCT", 16, :left_corner_3_fg_pct)
    end

    def test_handles_missing_right_corner_3_fgm
      assert_missing_key_returns_nil("Right Corner 3 FGM", 17, :right_corner_3_fgm)
    end

    def test_handles_missing_right_corner_3_fga
      assert_missing_key_returns_nil("Right Corner 3 FGA", 18, :right_corner_3_fga)
    end

    def test_handles_missing_right_corner_3_fg_pct
      assert_missing_key_returns_nil("Right Corner 3 FG_PCT", 19, :right_corner_3_fg_pct)
    end

    def test_handles_missing_corner_3_fgm
      assert_missing_key_returns_nil("Corner 3 FGM", 26, :corner_3_fgm)
    end

    def test_handles_missing_corner_3_fga
      assert_missing_key_returns_nil("Corner 3 FGA", 27, :corner_3_fga)
    end

    def test_handles_missing_corner_3_fg_pct
      assert_missing_key_returns_nil("Corner 3 FG_PCT", 28, :corner_3_fg_pct)
    end
