...
module NBA
  class DraftHistoryPickIdentityAttributeMappingTest < Minitest::Test
    cover DraftHistory

    def test_maps_pick_identity_attributes
      stub_draft_request

      pick = DraftHistory.all.first

      assert_equal 1_641_705, pick.player_id
      assert_equal 2023, pick.season
      assert_equal "Draft", pick.draft_type
    end
