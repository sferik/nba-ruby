...
module NBA
  class BoxScoreFourFactorsPlayerEdgeCasesTest < Minitest::Test
    ...
    def test_returns_empty_when_response_nil
      ...
      assert_equal 0, BoxScoreFourFactors.player_stats(game: "001", client: mock_client).size
      mock_client.verify
    end
    ...
    def test_returns_empty_when_no_result_sets
      ...
      assert_equal 0, BoxScoreFourFactors.player_stats(game: "001").size
    end
    ...
    def test_finds_result_set_when_not_first
      ...
      stub_request(:get, /boxscorefourfactorsv2/).to_return(body: response.to_json)
      stats = BoxScoreFourFactors.player_stats(game: "0022400001")
    ...
    def player_row
      ["0022400001", Team::GSW, "GSW", "Golden State", 201_939, "Stephen Curry", "G", "",
        "34:22", 0.62, 0.35, 0.12, 0.05, 0.48, 0.28, 0.15, 0.22]
    end
  end
end
